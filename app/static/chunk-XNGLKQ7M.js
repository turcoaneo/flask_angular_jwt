...
var UserPassGroupComponent = class _UserPassGroupComponent {
  componentKey = "";
  componentEmail = "";
  componentPass = "";
  ...
  static \u0275fac = function UserPassGroupComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _UserPassGroupComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserPassGroupComponent, selectors: [["app-user-pass-group"]], inputs: { componentKey: "componentKey", componentEmail: "componentEmail", componentPass: "componentPass" }, features: [\u0275\u0275ProvidersFeature([], [
    {
      provide: ControlContainer,
      useFactory: () => inject(ControlContainer, { skipSelf: true })
    }
  ])], decls: 17, vars: 16, consts: [[3, "formGroupName"], [3, "for"], ["type", "text", "aria-describedby", "signInHelp", "placeholder", "Enter email", 3, "formControlName", "name", "id"], ["id", "signInHelp", 1, "form-text", "text-muted", "block", "mt-6"], ["class", "error block", 4, "ngIf"], [1, "input-placeholder"], ["type", "password", "aria-describedby", "signInHelp", "placeholder", "*********", 2, "float", "left", 3, "formControlName", "name", "id", "type"], ["id", "togglePass", 3, "click"], ["id", "signInPassHelp", 1, "form-text", "text-muted", "block", "mt-6"], [1, "error", "block"]], template: function UserPassGroupComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserPassGroupComponent, { className: "UserPassGroupComponent", filePath: "src/app/components/user-pass-group/user-pass-group.component.ts", lineNumber: 18 });
})();
